        ...
        <div className="lg:col-span-1 space-y-4 bg-gray-900 text-base-100 p-6 rounded-lg shadow-lg lg:relative -top-24">
            ...
            <div>
                ...
                <div className="space-y-2">
                    <p className="text-sm text-gray-500 dark:text-gray-400">Email: user@example.com</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400">Phone: +1 234 567 890</p>
                </div>
            </div>
        </div>
    )
