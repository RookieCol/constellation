...
contract Crowdfunding is IERC1155Receiver, Ownable {
	...
	// 	require(openForWithdraw, 'withdrawForAll: the withdraw is closed');
	// 	require(
	// 		block.timestamp >= deadline,
	// 		'withdrawForAll: the deadline has not passed'
	// 	);
	// 	require(
	// 		address(this).balance < threshold,
	// 		'withdrawForAll: the threshold has been met'
	// 	);
	// 	require(
	// 		balances[msg.sender] > 0,
	// 		'withdrawForAll: the sender is not a staker'
	// 	);
	...
	// 		balances[staker] = 0;
	// 		(bool response, ) = staker.call{value: balance}('');
	// 		require(response, 'withdrawForAll: Failed to send Ether');
	...
	// 							' did not reach the threshold, it was transfer your stake of ',
	// 							balance.toString(),
	// 							' project'
	// 						)
	// 					)
